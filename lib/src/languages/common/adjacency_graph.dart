...
const Map<String, Map<String, List<String?>>> adjacencyGraph = {
  "azerty": {
    ...
    "ù": ["mM", "^\"", r"$£", "*µ", null, "!§"],
    "%": ["mM", "^\"", r"$£", "*µ", null, "!§"],
    "*": ["ù%", r"$£", null, null, null, null],
    "µ": ["ù%", r"$£", null, null, null, null],
  ...
  "qwerty": {
    ...
    "3": ["2@", null, null, r"4$", "eE", "wW"],
    "4": ["3#", null, null, "5%", "rR", "eE"],
    "5": [r"4$", null, null, "6^", "tT", "rR"],
    ...
    "!": ["`~", null, null, "2@", "qQ", null],
    "@": ["1!", null, null, "3#", "wW", "qQ"],
    "#": ["2@", null, null, r"4$", "eE", "wW"],
    r"$": ["3#", null, null, "5%", "rR", "eE"],
    "%": [r"4$", null, null, "6^", "tT", "rR"],
    "^": ["5%", null, null, "7&", "yY", "tT"],
    "&": ["6^", null, null, "8*", "uU", "yY"],
    "*": ["7&", null, null, "9(", "iI", "uU"],
    "(": ["8*", null, null, "0)", "oO", "iI"],
